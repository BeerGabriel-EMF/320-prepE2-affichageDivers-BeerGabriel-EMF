...
import services.ServiceFormattageDate;
import services.ServiceFormattageNombreEntier;
import services.ServiceFormattageNombreReel;

public class App {
    public static void main(String[] args) throws Exception {
        ServiceFormattageDate serviceFormattageDate = new ServiceFormattageDate();
        ...
        System.out.println(serviceFormattageDate.formattageDate(dateAFormatter, format1));
        System.out.println("Formattage dd-MM-yyyy");
        System.out.println(serviceFormattageDate.formattageDate(dateAFormatter, format2));
